            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-sm text-neutral-400">
                  Full-stack developer specializing in creating beautiful, functional web
                  applications.
                </p>
                ...
                <ul className="flex flex-col space-y-4">
                  <li className="flex flex-col space-y-1">
                    <span className="text-sm text-neutral-400">
                      CGEWHO Kendriya Vihar Greater Noida
                      <br />
                      Plot No.7, Sector P-4, Phi-2, Builders Area
                      <br />
                      Near Unitech Heights, Greater Noida
                      <br />
                  ...
                  <li className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="ml-2 text-neutral-400 transition-colors hover:text-orange-500"
                      title="Copy email"
                    >
                      {copiedEmail ? (
                        <svg
                  ...
                  <li>
                    <button
                      ...
                      className="flex w-fit items-center justify-center gap-2 rounded-lg bg-yellow-500 px-4 py-2 text-sm text-black transition-colors hover:bg-yellow-400"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
