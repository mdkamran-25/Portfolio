        ...
        <div className="flex flex-col space-y-6">
          <div>
            ...
            <p className="text-neutral-300">
              Have questions or want to work together? Feel free to reach out using the contact form or the information below.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            <div>
              ...
              <a href="mailto:webhost01001@gmail.com" className="text-neutral-300 hover:text-orange-500">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-neutral-700 bg-neutral-900 px-4 py-2 text-white focus:border-orange-500 focus:outline-none"
            ...
            <div>
              <label htmlFor="subject" className="mb-1 block text-sm font-medium text-neutral-300">
                Subject
              </label>
              <input
                type="text"
